...
const downloadTableAsPDF = async (table: HTMLElement) => {
    try {
        ...
        const title = 'Brand-management Report';
        pdf.setFontSize(16);
        pdf.setFont('helvetica', 'bold');
        ...
        pdf.save('Brand-management Report.pdf');
    } catch (error) {
					...
					<div className='col-12'>
						...
						<Card stretch>
							<CardTitle className='d-flex justify-content-between align-items-center m-4'>
								<div className='flex-grow-1 text-center text- <thead className={"table-dark border-primary"}>'>Manage Brand</div>
								<Dropdown>
